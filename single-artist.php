...
try {
    ...
    $row = $artistDB->findById($default);

    $paintDB = new PaintingDB($pdo);
    $paintings = $paintDB->findByArtist($default); 
...
<head>
    ...
    <!-- Title -->
    <title>Art Store | Artist Details</title>
                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item"><a href="browse-artists.php"><i class="fas fa-users"></i> Browse Artists</a></li>
                ...
                <section class="ui segment grey100">
                    <div class="ui doubling stackable grid container">
                        ...
                        <div class="seven wide column">
                            ...
                            <div class="item">
                                ...
                                <span class="badge badge-info">
                                    <?php echo utf8_encode($row['ArtistID']); ?>
                                </span>
                                <hr>
                                <div class="meta">
                                    <p>
                                        <?php echo  utf8_encode($row['Details']); ?>
                                    </p>
                                </div>
                            </div>

                            <!-- Tabs For Details, Museum, Genre, Subjects -->
                            <?php include 'includes/artist-small-tabs.inc.php'; ?>
                        ...
                        <div class="eight wide column">
                            <h2>List of Paintings by <?php echo  utf8_encode($row['FirstName'] . ' ' . $row['LastName']); ?></h2>
